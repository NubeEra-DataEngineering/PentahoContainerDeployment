...
RUN /usr/bin/wget https://privatefilesbucket-community-edition.s3.us-west-2.amazonaws.com/${BISERVER_TAG}/ce/server/pentaho-server-ce-${BISERVER_TAG}.zip -O /tmp/pentaho-server-ce-${BISERVER_TAG}.zip \
